      <td rowspan="2" class="infos">
        ...
        <?php if(!$obj->is_delete): ?>
          <?php if(''==$authorName=$obj->author_name&&sfConfig::get('app_vjCommentPlugin_guardbind')):
                  $authorName= Doctrine::getTable('sfGuardUser')->find($obj->user_id)->getUsername();
                  endif;
                  echo link_to_function(
                  image_tag('/vjCommentPlugin/images/comments.png') ,
                  "reply('".$obj->id."','".$authorName."')",
